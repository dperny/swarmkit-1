...
var _ = Describe("network.Allocator", func() {
	...
	BeforeEach(func() {
		// nil out the initialization maps so that they're fresh for every test
		initNetworks = nil
		initServices = nil
		initTasks = nil
	...
	Describe("Restoring", func() {
		...
		JustBeforeEach(func() {
			err = a.Restore(initNetworks, initServices, initTasks)
		})
	...
	Describe("Allocating and deallocating", func() {
		...
		JustBeforeEach(func() {
			...
			a.Restore(initNetworks, initServices, initTasks)
		})
...
var _ = Describe("IsServiceFullyAllocated", func() {
	var (
		service *api.Service
		result  bool
	)
	...
	JustBeforeEach(func() {
		result = IsServiceFullyAllocated(service)
	})
