...
type NodeSpec struct {
	...
	// SpecSigningConfig is the node-specific spec signing configuration.
	SpecSigningConfig *SpecSigningConfig `protobuf:"bytes,5,opt,name=spec_signing_config,json=specSigningConfig" json:"spec_signing_config,omitempty"`
	// Signature is the signature of this spec
	Signature *SpecSignature `protobuf:"bytes,6,opt,name=signature" json:"signature,omitempty"`
}
...
type ServiceSpec struct {
	...
	// The signature of this spec, including the signature of the constituient
	// specs.
	Signature *SpecSignature `protobuf:"bytes,10,opt,name=signature" json:"signature,omitempty"`
}
...
type TaskSpec struct {
	...
	// Signature of this spec
	Signature *SpecSignature `protobuf:"bytes,12,opt,name=signature" json:"signature,omitempty"`
}
...
type GenericRuntimeSpec struct {
	...
	Signature *SpecSignature        `protobuf:"bytes,3,opt,name=signature" json:"signature,omitempty"`
}
...
type NetworkAttachmentSpec struct {
	...
	// Signature is the signature of this spec
	Signature *SpecSignature `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
}
...
type ContainerSpec struct {
	...
	// Signature is the signature of this container spec
	Signature *SpecSignature `protobuf:"bytes,26,opt,name=signature" json:"signature,omitempty"`
}
...
type NetworkSpec struct {
	...
	// Signature is the signature of this spec
	Signature *SpecSignature `protobuf:"bytes,9,opt,name=signature" json:"signature,omitempty"`
}
...
type ClusterSpec struct {
	...
	// SpecSigningConfig is the cluster-wide spec signing configuration
	SpecSigningConfig SpecSigningConfig `protobuf:"bytes,9,opt,name=spec_signing_config,json=specSigningConfig" json:"spec_signing_config"`
	// Signature is the signature of this spec
	Signature *SpecSignature `protobuf:"bytes,10,opt,name=signature" json:"signature,omitempty"`
}
...
type SecretSpec struct {
	...
	// Signature is the signature of this spec
	Signature *SpecSignature `protobuf:"bytes,5,opt,name=signature" json:"signature,omitempty"`
}
...
type ConfigSpec struct {
	...
	Templating *Driver `protobuf:"bytes,3,opt,name=templating" json:"templating,omitempty"`
	// Signature is the signature of this spec
	Signature *SpecSignature `protobuf:"bytes,4,opt,name=signature" json:"signature,omitempty"`
}
...
func (m *NodeSpec) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.SpecSigningConfig != nil {
		m.SpecSigningConfig = &SpecSigningConfig{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.SpecSigningConfig, o.SpecSigningConfig)
	}
	if o.Signature != nil {
		m.Signature = &SpecSignature{}
		github_com_docker_swarmkit_api_deepcopy.Copy(m.Signature, o.Signature)
	}
}
...
func (m *NodeSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SpecSigningConfig != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.SpecSigningConfig.Size()))
		n2, err := m.SpecSigningConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n2
	...
	if m.Signature != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Signature.Size()))
...
func (m *ServiceSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintSpecs(dAtA, i, uint64(m.Annotations.Size()))
	n4, err := m.Annotations.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
	...
	i += n5
	if m.Mode != nil {
		nn6, err := m.Mode.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn6
	...
	if m.Endpoint != nil {
		...
		n8, err := m.Endpoint.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
	...
	if m.Rollback != nil {
		...
		n9, err := m.Rollback.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
	...
	if m.Signature != nil {
		...
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Signature.Size()))
		n10, err := m.Signature.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *TaskSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Restart != nil {
		...
		n15, err := m.Restart.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
	...
	if m.LogDriver != nil {
		...
		n17, err := m.LogDriver.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
...
func (m *TaskSpec_Attachment) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Attachment != nil {
		...
		n20, err := m.Attachment.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *TaskSpec_Generic) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Generic != nil {
		...
		n21, err := m.Generic.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *ContainerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StopGracePeriod != nil {
		...
		n25, err := m.StopGracePeriod.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
	...
	if m.PullOptions != nil {
		...
		n26, err := m.PullOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
	...
	if m.DNSConfig != nil {
		...
		n27, err := m.DNSConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	...
	if m.Healthcheck != nil {
		...
		n28, err := m.Healthcheck.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
	...
	if m.Signature != nil {
		...
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Signature.Size()))
		n31, err := m.Signature.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *EndpointSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Signature != nil {
		...
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Signature.Size()))
		n32, err := m.Signature.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *NetworkSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DriverConfig != nil {
		...
		n34, err := m.DriverConfig.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n34
	...
	if m.IPAM != nil {
		...
		n35, err := m.IPAM.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
	...
	if m.ConfigFrom != nil {
		nn36, err := m.ConfigFrom.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn36
	...
	if m.Signature != nil {
		...
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Signature.Size()))
		n37, err := m.Signature.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *ClusterSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n39, err := m.AcceptancePolicy.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n39
	...
	n40, err := m.Orchestration.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n40
	...
	n41, err := m.Raft.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n41
	...
	n42, err := m.Dispatcher.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n42
	...
	n43, err := m.CAConfig.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n43
	...
	n44, err := m.TaskDefaults.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n44
	...
	n45, err := m.EncryptionConfig.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n45
	...
	i++
	i = encodeVarintSpecs(dAtA, i, uint64(m.SpecSigningConfig.Size()))
	n46, err := m.SpecSigningConfig.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n46
	if m.Signature != nil {
		...
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Signature.Size()))
		n47, err := m.Signature.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
...
func (m *SecretSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintSpecs(dAtA, i, uint64(m.Annotations.Size()))
	n48, err := m.Annotations.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n48
	...
	if m.Templating != nil {
		...
		n49, err := m.Templating.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
	...
	if m.Driver != nil {
		...
		n50, err := m.Driver.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
	...
	if m.Signature != nil {
		...
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Signature.Size()))
		n51, err := m.Signature.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
...
func (m *ConfigSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintSpecs(dAtA, i, uint64(m.Annotations.Size()))
	n52, err := m.Annotations.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n52
	...
	if m.Templating != nil {
		...
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Templating.Size()))
		n53, err := m.Templating.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n53
	...
	if m.Signature != nil {
		...
		i++
		i = encodeVarintSpecs(dAtA, i, uint64(m.Signature.Size()))
		n54, err := m.Signature.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n54
...
type SignableSpec interface {
	github_com_gogo_protobuf_proto.Message
	GetSignature() *SpecSignature
	SetSignature(*SpecSignature)
...
func (s *TaskSpec) SetSignature(sig *SpecSignature) {
	if s == nil {
		return
	}
	s.Signature = sig
}
func (s *TaskSpec) GetSubspecs() []SignableSpec {
	if s == nil {
		return []SignableSpec{}
	}
	subspecs := []SignableSpec{}
	var runtime SignableSpec
	switch rs := s.Runtime.(type) {
	case *TaskSpec_Attachment:
		runtime = rs.Attachment
	case *TaskSpec_Container:
		runtime = rs.Container
	case *TaskSpec_Generic:
		runtime = rs.Generic
	}
	subspecs = append(subspecs, runtime)
	return subspecs
}
...
func (s *ClusterSpec) GetSignature() *SpecSignature {
	if s == nil {
		return nil
	}
	return s.Signature
}
func (s *ClusterSpec) SetSignature(sig *SpecSignature) {
	if s == nil {
		return
	}
	s.Signature = sig
}
func (s *ClusterSpec) GetSubspecs() []SignableSpec {
	if s == nil {
		return []SignableSpec{}
	}
	subspecs := []SignableSpec{}
...
func (s *ConfigSpec) SetSignature(sig *SpecSignature) {
	if s == nil {
		return
	}
	s.Signature = sig
...
func (s *ServiceSpec) GetSignature() *SpecSignature {
	if s == nil {
		return nil
	}
	return s.Signature
}
func (s *ServiceSpec) SetSignature(sig *SpecSignature) {
	if s == nil {
		return
	}
	s.Signature = sig
}
func (s *ServiceSpec) GetSubspecs() []SignableSpec {
	if s == nil {
		return []SignableSpec{}
	}
	subspecs := []SignableSpec{}
	subspecs = append(subspecs, &(s.Task))
...
func (s *NetworkAttachmentSpec) GetSignature() *SpecSignature {
	if s == nil {
		return nil
	}
	return s.Signature
}
func (s *NetworkAttachmentSpec) SetSignature(sig *SpecSignature) {
	if s == nil {
		return
	}
	s.Signature = sig
}
func (s *NetworkAttachmentSpec) GetSubspecs() []SignableSpec {
	if s == nil {
		return []SignableSpec{}
	}
	subspecs := []SignableSpec{}
...
func (s *ContainerSpec) GetSignature() *SpecSignature {
	if s == nil {
		return nil
	}
	return s.Signature
}
func (s *ContainerSpec) SetSignature(sig *SpecSignature) {
	if s == nil {
		return
	}
	s.Signature = sig
}
func (s *ContainerSpec) GetSubspecs() []SignableSpec {
	if s == nil {
		return []SignableSpec{}
	}
	subspecs := []SignableSpec{}
...
func (this *NodeSpec) String() string {
	...
	s := strings.Join([]string{`&NodeSpec{`,
		...
		`SpecSigningConfig:` + strings.Replace(fmt.Sprintf("%v", this.SpecSigningConfig), "SpecSigningConfig", "SpecSigningConfig", 1) + `,`,
		`Signature:` + strings.Replace(fmt.Sprintf("%v", this.Signature), "SpecSignature", "SpecSignature", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *ClusterSpec) String() string {
	...
	s := strings.Join([]string{`&ClusterSpec{`,
		...
		`SpecSigningConfig:` + strings.Replace(strings.Replace(this.SpecSigningConfig.String(), "SpecSigningConfig", "SpecSigningConfig", 1), `&`, ``, 1) + `,`,
		`Signature:` + strings.Replace(fmt.Sprintf("%v", this.Signature), "SpecSignature", "SpecSignature", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *NodeSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SpecSigningConfig", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.SpecSigningConfig.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
...
var fileDescriptorSpecs = []byte{
	...
	,
}
