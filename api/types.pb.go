...
type DefaultNetworkConfig struct {
	// DefaultAddressPool represents the set of address spaces from which we will
	// allocate address pools for each network that does not have an address pool
	// already chosen.
	DefaultAddressPool []*DefaultNetworkConfig_AddressPool `protobuf:"bytes,1,rep,name=default_address_pool,json=defaultAddressPool" json:"default_address_pool,omitempty"`
}

func (m *DefaultNetworkConfig) Reset()                    { *m = DefaultNetworkConfig{} }
func (*DefaultNetworkConfig) ProtoMessage()               {}
func (*DefaultNetworkConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{39} }

// AddressPool reprsents one possible address pool. It is based on the the
// github.com/docker/libnetwork/ipamutils.NetworkToSplit, and is used to
// define one possible block of the default address pool.
type DefaultNetworkConfig_AddressPool struct {
	// Base represents the default IP address pool, in CIDR notation, from
	// which to select default IP addresses. If Base is 10.0.0.0/8, then all
	// pools will be allocated from within the 10.0.0.0/8 subnet
	Base string `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	// PoolSize represents the size of the pools actually allocated to each
	// network. If the size is 24, then each pool will be a /24 subnet of the
	// total subnet defined in Base.
	PoolSize uint32 `protobuf:"varint,2,opt,name=pool_size,json=poolSize,proto3" json:"pool_size,omitempty"`
}

func (m *DefaultNetworkConfig_AddressPool) Reset()      { *m = DefaultNetworkConfig_AddressPool{} }
func (*DefaultNetworkConfig_AddressPool) ProtoMessage() {}
func (*DefaultNetworkConfig_AddressPool) Descriptor() ([]byte, []int) {
...
func init() {
	...
	proto.RegisterType((*DefaultNetworkConfig)(nil), "docker.swarmkit.v1.DefaultNetworkConfig")
	proto.RegisterType((*DefaultNetworkConfig_AddressPool)(nil), "docker.swarmkit.v1.DefaultNetworkConfig.AddressPool")
...
func (m *DefaultNetworkConfig) Copy() *DefaultNetworkConfig {
	if m == nil {
		return nil
	}
	o := &DefaultNetworkConfig{}
	o.CopyFrom(m)
	return o
}

func (m *DefaultNetworkConfig) CopyFrom(src interface{}) {

	o := src.(*DefaultNetworkConfig)
	*m = *o
	if o.DefaultAddressPool != nil {
		m.DefaultAddressPool = make([]*DefaultNetworkConfig_AddressPool, len(o.DefaultAddressPool))
		for i := range m.DefaultAddressPool {
			m.DefaultAddressPool[i] = &DefaultNetworkConfig_AddressPool{}
			github_com_docker_swarmkit_api_deepcopy.Copy(m.DefaultAddressPool[i], o.DefaultAddressPool[i])
		}
	}

}

func (m *DefaultNetworkConfig_AddressPool) Copy() *DefaultNetworkConfig_AddressPool {
	if m == nil {
		return nil
	}
	o := &DefaultNetworkConfig_AddressPool{}
	o.CopyFrom(m)
	return o
}

func (m *DefaultNetworkConfig_AddressPool) CopyFrom(src interface{}) {

	o := src.(*DefaultNetworkConfig_AddressPool)
	*m = *o
}
...
func (m *DefaultNetworkConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DefaultNetworkConfig) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.DefaultAddressPool) > 0 {
		for _, msg := range m.DefaultAddressPool {
			dAtA[i] = 0xa
			i++
			i = encodeVarintTypes(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *DefaultNetworkConfig_AddressPool) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DefaultNetworkConfig_AddressPool) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.PoolSize != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.PoolSize))
	}
	return i, nil
}
...
func (m *DefaultNetworkConfig) Size() (n int) {
	var l int
	_ = l
	if len(m.DefaultAddressPool) > 0 {
		for _, e := range m.DefaultAddressPool {
			l = e.Size()
			n += 1 + l + sovTypes(uint64(l))
		}
	}
...
func (m *DefaultNetworkConfig_AddressPool) Size() (n int) {
	var l int
	_ = l
	l = len(m.Base)
	if l > 0 {
	...
	if m.PoolSize != 0 {
		n += 1 + sovTypes(uint64(m.PoolSize))
	}
	return n
}
...
func (this *DefaultNetworkConfig) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&DefaultNetworkConfig{`,
		`DefaultAddressPool:` + strings.Replace(fmt.Sprintf("%v", this.DefaultAddressPool), "DefaultNetworkConfig_AddressPool", "DefaultNetworkConfig_AddressPool", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *DefaultNetworkConfig_AddressPool) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&DefaultNetworkConfig_AddressPool{`,
		`Base:` + fmt.Sprintf("%v", this.Base) + `,`,
		`PoolSize:` + fmt.Sprintf("%v", this.PoolSize) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *DefaultNetworkConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DefaultNetworkConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DefaultNetworkConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.DefaultAddressPool = append(m.DefaultAddressPool, &DefaultNetworkConfig_AddressPool{})
			if err := m.DefaultAddressPool[len(m.DefaultAddressPool)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DefaultNetworkConfig_AddressPool) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddressPool: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddressPool: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorTypes = []byte{
	...
	,
}
