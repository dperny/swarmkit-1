...
// Algorithm is the algorithm used with this key
type SpecSigningConfig_Algorithm int32

const (
	// TODO(dperny): I don't know which algorithms are good actually which is a
	// pretty dumb thing to not know but I'm a mediocre white guy and I'm not
	// going to let me utter lack of qualifications stop me. So, anyway, todo
	// add more algorithms
	RSA SpecSigningConfig_Algorithm = 0
)

var SpecSigningConfig_Algorithm_name = map[int32]string{
	0: "RSA",
}
var SpecSigningConfig_Algorithm_value = map[string]int32{
	"RSA": 0,
}

func (x SpecSigningConfig_Algorithm) String() string {
	return proto.EnumName(SpecSigningConfig_Algorithm_name, int32(x))
}
func (SpecSigningConfig_Algorithm) EnumDescriptor() ([]byte, []int) {
...
// SpecSigningConfig is the configuration for signed specs, including the
// public key used to verify signatures and the enforcement policy.
type SpecSigningConfig struct {
	// Enable is whether to check all signatures
	Enable    bool                        `protobuf:"varint,1,opt,name=enable,proto3" json:"enable,omitempty"`
	Algorithm SpecSigningConfig_Algorithm `protobuf:"varint,2,opt,name=algorithm,proto3,enum=docker.swarmkit.v1.SpecSigningConfig_Algorithm" json:"algorithm,omitempty"`
	// PublicKey is the public key used to verify the signature of specs.
	PublicKey []byte `protobuf:"bytes,3,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"`
}

func (m *SpecSigningConfig) Reset()                    { *m = SpecSigningConfig{} }
func (*SpecSigningConfig) ProtoMessage()               {}
func (*SpecSigningConfig) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{39} }
...
// SpecSignature is the signature of a cluster spec object, signed with an
// external private key. Is a separate message type in case we want to add more
// fields later.
type SpecSignature struct {
	// Signature is the actual sigature, as a bytestring
	Signature []byte `protobuf:"bytes,1,opt,name=signature,proto3" json:"signature,omitempty"`
}

func (m *SpecSignature) Reset()                    { *m = SpecSignature{} }
func (*SpecSignature) ProtoMessage()               {}
func (*SpecSignature) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{56} }
...
func init() {
	...
	proto.RegisterType((*SpecSigningConfig)(nil), "docker.swarmkit.v1.SpecSigningConfig")
	...
	proto.RegisterType((*SpecSignature)(nil), "docker.swarmkit.v1.SpecSignature")
	...
	proto.RegisterEnum("docker.swarmkit.v1.SpecSigningConfig_Algorithm", SpecSigningConfig_Algorithm_name, SpecSigningConfig_Algorithm_value)
...
func (m *SpecSigningConfig) Copy() *SpecSigningConfig {
	if m == nil {
		return nil
	}
	o := &SpecSigningConfig{}
...
func (m *SpecSigningConfig) CopyFrom(src interface{}) {

	o := src.(*SpecSigningConfig)
	*m = *o
	if o.PublicKey != nil {
		m.PublicKey = make([]byte, len(o.PublicKey))
		copy(m.PublicKey, o.PublicKey)
	}
}
...
func (m *SpecSignature) Copy() *SpecSignature {
	if m == nil {
		return nil
	}
	o := &SpecSignature{}
...
func (m *SpecSignature) CopyFrom(src interface{}) {

	o := src.(*SpecSignature)
	*m = *o
	if o.Signature != nil {
		m.Signature = make([]byte, len(o.Signature))
		copy(m.Signature, o.Signature)
	}
}
...
func (m *SpecSigningConfig) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SpecSigningConfig) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SpecSignature) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SpecSignature) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SpecSigningConfig) Size() (n int) {
	var l int
	_ = l
	if m.Enable {
		n += 2
...
func (m *SpecSignature) Size() (n int) {
	var l int
	_ = l
	l = len(m.Signature)
	if l > 0 {
...
func (this *SpecSigningConfig) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SpecSigningConfig{`,
...
func (this *SpecSignature) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SpecSignature{`,
...
func (m *SpecSigningConfig) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SpecSigningConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SpecSigningConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Algorithm |= (SpecSigningConfig_Algorithm(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *SpecSignature) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SpecSignature: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SpecSignature: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorTypes = []byte{
	// 5093 bytes of a gzipped FileDescriptorProto
	,
}
